...
class CrowdCounterHandler(object):
    ...
    def initialize(self, ctx):
        ...
        from crowdmodel_shb import CrowdCounter
        
        # Read model serialize/pt file
        model_pt_path = os.path.join(model_dir, "ssdcnet_shb_best_epoch.pth")
        # Read model definition file
        model_def_path = os.path.join(model_dir, "crowdmodel_shb.py")
